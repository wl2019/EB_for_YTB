...
namespace YTB
{
    static class MyStart
    {
        ...
        public static string gszMrktMnger,gszMrktName,gszMrktAddr,gszMrktTel,gszWeight;
        ...
        public static DateTime gdtLogin;
        ...
        static void Main()
        {
            ...
            if (gszYTBIp.CompareTo("183.58.24.209") == 0)//生产环境
                gszHttpSrv = "http://183.58.24.209:8088/ytb-http-sersc/servlet/server";
            else
